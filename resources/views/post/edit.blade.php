        ...
        <div class="col-md-8">
            <form action="{{ route('post.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="post_title" value="{{ $single_post[0]['title'] }}" class="form-control"
                            size="60" />
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-9">
                        <img id="uploadPreview" src="{{ url('uploads/post_images/' . $single_post[0]['thumbnail_path']) }}" height="300px" width="400px" alt="">
                    </div>
                </div>
                <div class="row mb-5">
