    <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-12 px-0">
            <a class="text-white" style="text-decoration: none;" href="{{url('post/'.$featured_post[0]['post_slug'])}}"><h1 class=" font-italic">{!! Str::limit(strip_tags($featured_post[0]['title']), 40,'....') !!}</h1>
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    {!! Str::limit(strip_tags($featured_post[2]['content']), 125,'<a href="'.url('post/'.$featured_post[2]['post_slug']).'"> Continue reading</a>') !!}
                </div>
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    {!! Str::limit(strip_tags($featured_post[1]['content']), 125,'<a href="'.url('post/'.$featured_post[1]['post_slug']).'"> Continue reading</a>') !!}
                </div>
